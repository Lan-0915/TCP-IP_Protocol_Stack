...
#define plat_strlen         kernel_plat_strlen
...
#define plat_memcpy         kernel_plat_memcpy
#define plat_memcmp         kernel_plat_memcmp
#define plat_sprintf        kernel_sprintf
#define plat_vsprintf       kernel_plat_vsprintf
